        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-lg-3 col-md-4 col-sm-6">
            ...
            <div class="payment-accept">
              ...
              <div class="payment-icon"><img src="{{ asset('source/bower_components/library/site/version4/images/paypal.png') }}" alt="paypal"> <img src="{{ asset('source/bower_components/library/site/version4/images/visa.png') }}" alt="visa"> <img src="{{ asset('source/bower_components/library/site/version4/images/american-exp.png') }}" alt="american express"> <img src="{{ asset('source/bower_components/library/site/version4/images/mastercard.png') }}" alt="mastercard"></div>
            </div>
          </div>
        </div>
      </div>
...
<!-- JavaScript --> 
<script src="{{ asset('source/bower_components/library/site/version4/js/jquery.min.js') }}"></script> 
<script src="{{ asset('source/bower_components/library/site/version4/js/bootstrap.min.js') }}"></script> 
<script src="{{ asset('source/bower_components/library/site/version4/js/revslider.js') }}"></script> 
<script src="{{ asset('source/bower_components/library/site/version4/js/main.js') }}"></script> 
<script src="{{ asset('source/bower_components/library/site/version4/js/owl.carousel.min.js') }}"></script> 
<script src="{{ asset('source/bower_components/library/site/version4/js/mob-menu.js') }}"></script> 
<script src="{{ asset('source/bower_components/library/site/version4/js/countdown.js') }}"></script> 
<script src="{{ asset('source/bower_components/library/site/version4/js/cloud-zoom.js') }}"></script>
<script src="{{ asset('source/bower_components/library/site/version4/js/star-rating.js') }}"></script>
