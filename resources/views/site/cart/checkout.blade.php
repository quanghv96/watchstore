      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li> <strong>{{ __('Checkout') }}</strong> </li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="title-tab-product-category">
              <div class="text-center">
                <ul class="nav jtv-heading-style" role="tablist">
                  <li role="presentation" class=""><a href="#cart" aria-controls="cart" role="tab" data-toggle="tab">{{ __('1 Shopping cart') }}</a></li>
                  <li role="presentation"><a href="#checkout" aria-controls="checkout" role="tab" data-toggle="tab">{{ __('2 Check Imfomation') }}</a></li>
                  <li role="presentation" class="active"><a href="#complete-order" aria-controls="complete-order" role="tab" data-toggle="tab">{{ __('3 Checkout') }}</a></li>
                </ul>
              </div>
            </div>
            <br>
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            ...
                                            {!! Form::select('address_id', $addresses, null, ['required', 'class' => 'address', 'placeholder' => 'Chọn một địa chỉ', 'style' => 'width: 160px']) !!}
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
